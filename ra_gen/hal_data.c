...
{ .mode = TIMER_MODE_PWM,
/* Actual period: 0.00202425 seconds. Actual duty: 49.997941624469966%. */.period_counts = (uint32_t) 0x5ee3,
  .duty_cycle_counts = 0x2f71, .source_div = (timer_source_div_t) 2, .channel = 7, .p_callback = NULL,
...
{ .data_flash_bgo = true, .p_callback = flash_callback, .p_context = NULL, .ipl = (2),
...
/* Actual period: 0.002 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x17700,
  .duty_cycle_counts = 0xbb80, .source_div = (timer_source_div_t) 0, .channel = 0, .p_callback = timer0_callback,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
{ .clock_source = RTC_CLOCK_SOURCE_LOCO, .freq_compare_value_loco = 255, .p_err_cfg = &g_rtc0_err_cfg, .p_callback =
          rtc_callback,
  .p_context = NULL, .alarm_ipl = (2), .periodic_ipl = (2), .carry_ipl = (2),
